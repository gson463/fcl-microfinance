-- Repayments often have amount filled but principal_paid / interest_paid NULL (wallet insert path).
-- Align collected_month_principal / collected_month_interest with collected_month_total (SUM(amount)).
